...
plt.plot(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验一：基本功能在不同数据大小上的运行时间', fontsize=14)
...
plt.figure(figsize=(10, 6))
plt.loglog(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验一：基本功能在不同数据大小上的运行时间 (对数刻度)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.figure(figsize=(10, 6))
plt.plot(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.plot(data_sizes, rp_times, 's-', linewidth=2, markersize=8, label='结果保护功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验二：基本功能与基于差分隐私的数据保护功能对比', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.figure(figsize=(10, 6))
plt.loglog(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.loglog(data_sizes, rp_times, 's-', linewidth=2, markersize=8, label='结果保护功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验二：基本功能与基于差分隐私的数据保护功能对比 (对数刻度)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.figure(figsize=(10, 6))
plt.plot(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.plot(data_sizes, de_times, '^-', linewidth=2, markersize=8, label='双重执行功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验三：基本功能与基于双向执行的安全性增强功能对比', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.figure(figsize=(10, 6))
plt.loglog(data_sizes, basic_times, 'o-', linewidth=2, markersize=8, label='基本功能')
plt.loglog(data_sizes, de_times, '^-', linewidth=2, markersize=8, label='双重执行功能')
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('实验三：基本功能与基于双向执行的安全性增强功能对比 (对数刻度)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('三种功能在不同数据大小上的运行时间对比', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.xlabel('数据大小 (MB)', fontsize=12)
plt.ylabel('运行时间 (ms)', fontsize=12)
plt.title('三种功能在不同数据大小上的运行时间对比 (对数刻度)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.xticks(data_sizes)
plt.legend(fontsize=12)
plt.tight_layout()
