...
{	
	if(!dualExecution){
		...
		if(printResult){
			if(resultProtection){
				customer.Print_Avg_ResultProtection("AVG(orders.annotation)");
			}
			else{
				customer.Print();
			}
...
void run_Q8_m(DataSize ds, bool printResult, bool resultProtection, bool dualExecution)
{
	if(!dualExecution){
		...
		if (printResult)
		{
			if(resultProtection){
				orders.Print_Avg_ResultProtection("AVG(orders.annotation)");
				orders_copy.Print_Avg_ResultProtection("AVG(orders_copy.annotation)");
			}
			else{
				orders.Print();
				orders_copy.Print();
...
void run_Q9_m(DataSize ds, bool printResult, bool resultProtection, bool dualExecution)
{
	...
	if(!dualExecution){
		...
		if (printResult){
			if(resultProtection){
				out.Print_Avg_ResultProtection("AVG(orders_copy.annotation)");
			}
			else{
				out.Print();
			}
